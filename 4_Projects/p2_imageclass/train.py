...
parser.add_argument ('--arch',choices = ['Vgg16', 'resnet18'], help = 'Vgg16 is default, alternatively use any other allowed options', type = str, default = 'Vgg16')
...
parser.add_argument ('--hidden_units', choices = [2048, 2014, 512, 256, 128], help = 'Hidden units in Classifier, default is 512', type = int, default = 512)
...
#python3 train.py 'flower_data_small_set' --arch 'Other' --learning_rate 0.05 --hidden_units 128 --epochs 1
#python3 train.py 'flower_data_small_set' --arch 'Vgg16' --learning_rate 0.01 --hidden_units 128 --epochs 1
